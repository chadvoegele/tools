...
def getTemp():
  if config.is_desktop():
    cpuTempFile0 = '/sys/devices/platform/coretemp.0/hwmon/hwmon0/temp2_input'
    cpuTempRead0 = open(cpuTempFile0, 'r')
    cpuTemp0 = int(int(cpuTempRead0.readline())/1000)
    cpuTempRead0.close()

    cpuTempFile1 = '/sys/devices/platform/coretemp.0/hwmon/hwmon0/temp3_input'
    cpuTempRead1 = open(cpuTempFile1, 'r')
    cpuTemp1 = int(int(cpuTempRead1.readline())/1000)
    cpuTempRead1.close()

    cpuTempFile2 = '/sys/devices/platform/coretemp.0/hwmon/hwmon0/temp4_input'
    cpuTempRead2 = open(cpuTempFile2, 'r')
    cpuTemp2 = int(int(cpuTempRead2.readline())/1000)
    cpuTempRead2.close()

    cpuTempFile3 = '/sys/devices/platform/coretemp.0/hwmon/hwmon0/temp5_input'
